...
import com.Penumbra.mccourse.block.RedwoodTree;
import com.Penumbra.mccourse.util.Registration;
import com.Penumbra.mccourse.world.feature.ModConfiguredFeatures;
...
public class ModBiomes
{
    ...
    private static Biome makeOilBiome(final Supplier<ConfiguredSurfaceBuilder<?>> surfaceBuilder, float depth, float scale) {
        ...
        biomegenerationsettings$builder.withFeature(GenerationStage.Decoration.SURFACE_STRUCTURES, Features.PATCH_DEAD_BUSH);

        biomegenerationsettings$builder.withFeature(GenerationStage.Decoration.VEGETAL_DECORATION,
                Feature.TREE.withConfiguration(RedwoodTree.REDWOOD_TREE_CONFIG)
